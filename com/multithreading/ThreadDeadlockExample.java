...
public class ThreadDeadlockExample {
		...
		public static void main(String[] args) {
			final ThreadDeadlockExample threadDeadlockExample = new ThreadDeadlockExample();
			Thread t1 = new Thread(() -> {
				while (true) {
					synchronized (threadDeadlockExample.object1) {
						try {
						...
						synchronized (threadDeadlockExample.object2) {
